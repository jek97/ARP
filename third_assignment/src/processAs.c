...
int main(int argc, char *argv[]) {
    ...
    while (TRUE) {
        ...
        else if(in_buf[0] == 'L' || in_buf[0] == 'R' || in_buf[0] == 'U' || in_buf[0] == 'D') {

            if (in_buf[0] == 'L') { // check which arrow message arrived
                cmd_i = KEY_LEFT; // set the command variable
            }
            else if (in_buf[0] == 'R') { // check which arrow message arrived
                cmd_i = KEY_RIGHT; // set the command variable
            }
            else if (in_buf[0] == 'U') { // check which arrow message arrived
                cmd_i = KEY_UP; // set the command variable
            }
            else if (in_buf[0] == 'D') { // check which arrow message arrived
